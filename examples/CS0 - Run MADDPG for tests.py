...
dataset_name = 'cs5'
episodes = 2
path_save = "./tiago_thesis/Empirical_Reward_Test/MADDPG_scaled_rewards_v1_without_squash_all_D_V2_test"

env = CityLearnEnv(dataset_name, central_agent=False, reward_function=V2GPenaltyReward,simulation_end_time_step=1000)
#env.reward_function.SQUASH = 1


averages = []
model = RLAgent(env, steps_between_training_updates=10)
