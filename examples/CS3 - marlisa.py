...
rewards, average_runtime, kpis_list = model.learn(episodes=6, keep_env_history=True, env_history_directory="./sc2_marlisa1")
end_time = time.time()
...
np.save('./sc2_marlisa1/kpis_list.npy', kpis_list)

rewards = np.array(rewards)  # If not already a NumPy array
np.save('./sc2_marlisa1/rewards.npy', rewards)
